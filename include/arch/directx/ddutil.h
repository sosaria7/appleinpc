...
public:
	...
	HRESULT StretchBlt( RECT *destRect, LPDIRECTDRAWSURFACE7 pSourceSurface, RECT *sourceRect = NULL, DWORD dwFlags = 0, LPDDBLTFX lpDDBltFx = NULL );
...
public:
	HRESULT DrawBitmapIn( TCHAR* strBMP, DWORD dwX, DWORD dwY, DWORD dwWidth=0, DWORD dwHeight=0);
	HRESULT DrawBitmapIn( HBITMAP hBMP, DWORD dwX, DWORD dwY, DWORD dwWidth=0, DWORD dwHeight=0);
	HRESULT Clear( DWORD dwColor = 0L );
